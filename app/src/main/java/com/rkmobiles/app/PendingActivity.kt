...
db.pendingRows().forEach{r->val row=LinearLayout(this);row.orientation=LinearLayout.HORIZONTAL;row.setPadding(14,14,8,14);row.setBackgroundResource(R.drawable.card)
